...
let registrationClose = document.getElementById("registration-close");
let haveAccount = document.getElementsByClassName("login__signup");
let regClose = document.getElementById("registration-close");
...
function showRegistration() {
  registration.classList.add("show-registration");
}
...
signUpBtn.addEventListener("click", showRegistration);
registrationClose.addEventListener("click", hideRegistration);
haveAccount.addEventListener("click", alreadyHaveAnAccount);
regClose.addEventListener("click", hideRegistration);
